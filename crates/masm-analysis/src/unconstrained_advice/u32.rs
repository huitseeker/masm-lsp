...
pub(crate) fn expr_u32_sink_fact(expr: &Expr, env: &Env) -> AdviceFact {
    match expr {
...
pub(crate) fn intrinsic_u32_sink_fact(intrinsic: &Intrinsic, env: &Env) -> AdviceFact {
...
mod tests {
    ...
    use crate::unconstrained_advice::{domain::AdviceFact, transfer::Env, u32_domain::U32Validity};
    ...
    fn proven_u32_operand_does_not_trigger_expression_sink() {
        ...
        assert!(env.fact_for_var(&arg).has_concrete_sources());
