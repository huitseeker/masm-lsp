//! Phase 2 labeled corpus for `u32` advice-analysis behavior.
...
/// One expected advice-origin location recorded in the Phase 2 corpus.
...
/// One labeled Phase 2 corpus fixture.
...
struct CorpusCase {
    ...
    /// Whether diagnostics outside the Phase 2 `u32` corpus are allowed.
...
/// Return whether a sink belongs to the `u32`-focused Phase 2 corpus.
...
/// Return one expected origin location for the Phase 2 corpus.
...
/// Initial labeled `u32` corpus used to drive the Phase 2 demo.
...
/// Return the initial labeled `u32` corpus used to drive the Phase 2 demo.
fn corpus_cases() -> &'static [CorpusCase] {
    &CORPUS_CASES
}

#[test]
fn phase2_u32_corpus_matches_current_labels() {
