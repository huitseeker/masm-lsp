...
fn build_summary(input_count: usize, stmts: &[Stmt], output_count: usize, env: &Env) -> AdviceSummary {
...
/// Return the exact input position forwarded by an output, if the output is an alias of that input.
